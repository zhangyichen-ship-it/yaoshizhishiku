    ...
    (s.exports = (function () {
      var t = 1e3,
        ...
        $ = {
          ...
          p: function (t) {
            return (
              { M: c, y: h, w: u, d: o, D: d, h: a, m: i, s: s, ms: n, Q: f }[t] ||
              String(t || "")
                .toLowerCase()
                .replace(/s$/, "")
            );
      ...
      var O = (function () {
          ...
          return (
            ...
            (M.$g = function (t, e, r) {
              return Y.u(t) ? this[e] : this.set(r, t);
            }),
            (M.unix = function () {
            ...
            (M.startOf = function (t, e) {
              var r = this,
                ...
                f = Y.p(t),
                l = function (t, e) {
                  var s = Y.w(r.$u ? Date.UTC(r.$y, e, t) : new Date(r.$y, e, t), r);
              ...
              switch (f) {
                ...
                case c:
                  return n ? l(1, y) : l(0, y + 1);
                case u:
                  var w = this.$locale().weekStart || 0,
                    v = (p < w ? p + 7 : p) - w;
                  return l(n ? M - v : M + (6 - v), y);
                case o:
                case d:
                  return m($ + "Hours", 0);
                case a:
            ...
            (M.$set = function (t, e) {
              ...
              if (u === c || u === h) {
                ...
                (p.$d[l](m), p.init(), (this.$d = p.set(d, Math.min(this.$D, p.daysInMonth())).$d));
              } else l && this.$d[l](m);
            ...
            (M.add = function (n, f) {
              ...
              var m = Y.p(f),
                p = function (t) {
                  var e = S(l);
                  return Y.w(e.date(e.date() + Math.round(t * n)), l);
                };
              if (m === c) return this.set(c, this.$M + n);
              if (m === h) return this.set(h, this.$y + n);
              if (m === o) return p(1);
              if (m === u) return p(7);
              var y = ((d = {}), (d[i] = e), (d[a] = r), (d[s] = t), d)[m] || 1,
  ...
  : ((o = 1),
    (u.exports = (function () {
      ...
      function l(r) {
        ...
        ((n = r), (s = a && a.formats));
        for (
          var i = (r = n.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g, function (e, r, n) {
              var i = n && n.toUpperCase();
              return (
                r ||
                s[n] ||
                t[n] ||
                s[i].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g, function (t, e, r) {
                  return e || r.slice(1);
                })
              );
            })).match(e),
          ...
          var c = i[u],
            ...
            h = f && f[0],
            l = f && f[1];
          i[u] = l ? { regex: h, parser: l } : c.replace(/^\[|\]$/g, "");
        }
        return function (t) {
      ...
      return function (t, e, r) {
        ((r.p.customParseFormat = !0), t && t.parseTwoDigitYear && (o = t.parseTwoDigitYear));
        var n = e.prototype,
          s = n.parse;
        n.parse = function (t) {
          var e = t.date,
          ...
          if ("string" == typeof o) {
            ...
            (c && (h = i[2]),
              ...
              (this.$d = (function (t, e, r, n) {
                try {
                  ...
                  var w,
                    ...
                    k = h || 0;
                  return d
                    ? new Date(Date.UTC(M, $, y, v, D, g, k + 60 * d.offset * 1e3))
                    : r
                      ? new Date(Date.UTC(M, $, y, v, D, g, k))
                      : ((w = new Date(M, $, y, v, D, g, k)), m && (w = n(w).week(m).toDate()), w);
                } catch (S) {
                  return new Date("");
                }
              })(e, o, n, r)),
              ...
              f && e != this.format(o) && (this.$d = new Date("")),
              (a = {}));
          } else if (o instanceof Array)
            for (var d = o.length, m = 1; m <= d; m += 1) {
              i[1] = o[m - 1];
    ...
    (d.exports = function (t, e, r) {
      var n = e.prototype,
        ...
        o = function (t, e) {
          return (
            t.formats[e] ||
            t.formats[e.toUpperCase()].replace(
              /(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,
              function (t, e, r) {
                return e || r.slice(1);
              }
        ...
        function (t, e, r) {
          ...
          ((n.week = function (t) {
            ...
            if (11 === this.month() && this.date() > 25) {
              var n = r(this).startOf(D).add(1, D).date(e),
                s = r(this).endOf(v);
              if (n.isBefore(s)) return 1;
            }
            var i = r(this).startOf(D).date(e).startOf(v).subtract(1, "millisecond"),
              a = this.diff(i, v, !0);
            return a < 0 ? r(this).startOf("week").week() : Math.ceil(a);
          }),
            (n.weeks = function (t) {
...
var _ =
  (b ||
    ((b = 1),
    (L.exports = function (t, e, r) {
      e.prototype.dayOfYear = function (t) {
        var e = Math.round((r(this).startOf("day") - r(this).startOf("year")) / 864e5) + 1;

import { m as t, u as e, e as n, f as r, d as s } from "./mdurl.Dwcmq5MZ.js";
import { u as o, P as i, r as c } from "./uc.micro.CRGj88R_.js";
import { d as l } from "./entities.zpoy7YfM.js";
import { L as a } from "./linkify-it.xinbW_ni.js";
import { p as h } from "./punycode.js.BkBFhtvi.js";
function u(t) {
  return (
    "[object String]" ===
    (function (t) {
...
const g = /\\([!"#$%&'()*+,\-./:;<=>?@[\\\]^_`{|}~])/g,
  b = new RegExp(g.source + "|" + /&([a-z#][a-z0-9]{1,31});/gi.source, "gi"),
  _ = /^#((?:x[a-f0-9]{1,8}|[0-9]{1,8}))$/i;
function C(t) {
  return t.indexOf("\\") < 0 && t.indexOf("&") < 0
    ? t
    : t.replace(b, function (t, e, n) {
        return (
          e ||
          (function (t, e) {
            if (35 === e.charCodeAt(0) && _.test(e)) {
              const n =
                "x" === e[1].toLowerCase() ? parseInt(e.slice(2), 16) : parseInt(e.slice(1), 10);
              return k(n) ? m(n) : t;
            }
            const n = l(t);
            return n !== t ? n : t;
...
function v(t) {
  return y.test(t) ? t.replace(A, M) : t;
}
const S = /[.?*+^$[\]\\(){}|-]/g;
function w(t) {
  switch (t) {
    ...
    Object.defineProperty(
      {
        ...
        parseLinkDestination: function (t, e, n) {
          ...
          if (60 === t.charCodeAt(s)) {
            for (s++; s < n; ) {
              if (((r = t.charCodeAt(s)), 10 === r)) return o;
              if (60 === r) return o;
              if (62 === r)
                return ((o.pos = s + 1), (o.str = C(t.slice(e + 1, s))), (o.ok = !0), o);
              92 === r && s + 1 < n ? (s += 2) : s++;
            }
            return o;
          }
          let i = 0;
          for (; s < n && ((r = t.charCodeAt(s)), 32 !== r) && !(r < 32 || 127 === r); )
            if (92 === r && s + 1 < n) {
              if (32 === t.charCodeAt(s + 1)) break;
              s += 2;
            } else {
              if (40 === r && (i++, i > 32)) return o;
              if (41 === r) {
                if (0 === i) break;
                i--;
              }
          ...
          return (e === s || 0 !== i || ((o.str = C(t.slice(e, s))), (o.pos = s), (o.ok = !0)), o);
        },
        parseLinkLabel: function (t, e, n) {
          ...
          for (t.pos = e + 1, r = 1; t.pos < c; ) {
            ...
            if (((i = t.pos), t.md.inline.skipToken(t), 91 === o))
              if (i === t.pos - 1) r++;
              else if (n) return ((t.pos = l), -1);
          }
          let a = -1;
          return (s && (a = t.pos), (t.pos = l), a);
        },
        parseLinkTitle: function (t, e, n, r) {
          ...
          if (r) ((i.str = r.str), (i.marker = r.marker));
          else {
            if (o >= n) return i;
            let r = t.charCodeAt(o);
            if (34 !== r && 39 !== r && 40 !== r) return i;
            (e++, o++, 40 === r && (r = 41), (i.marker = r));
          }
          for (; o < n; ) {
            if (((s = t.charCodeAt(o)), s === i.marker))
              return ((i.pos = o + 1), (i.str += C(t.slice(e, o))), (i.ok = !0), i);
            if (40 === s && 41 === i.marker) return i;
            (92 === s && o + 1 < n && o++, o++);
          }
          return ((i.can_continue = !0), (i.str += C(t.slice(e, o))), i);
        },
      },
      Symbol.toStringTag,
      { value: "Module" }
...
((j.code_inline = function (t, e, n, r, s) {
  const o = t[e];
  return "<code" + s.renderAttrs(o) + ">" + v(o.content) + "</code>";
}),
  (j.code_block = function (t, e, n, r, s) {
    const o = t[e];
    return "<pre" + s.renderAttrs(o) + "><code>" + v(t[e].content) + "</code></pre>\n";
  }),
  (j.fence = function (t, e, n, r, s) {
    const o = t[e],
      i = o.info ? C(o.info).trim() : "";
    let c,
      l = "",
      a = "";
    if (i) {
      const t = i.split(/(\s+)/g);
      ((l = t[0]), (a = t.slice(2).join("")));
    }
    if (
      ((c = (n.highlight && n.highlight(o.content, l, a)) || v(o.content)), 0 === c.indexOf("<pre"))
    )
      return c + "\n";
    if (i) {
      ...
      t < 0
        ? e.push(["class", n.langPrefix + l])
        : ((e[t] = e[t].slice()), (e[t][1] += " " + n.langPrefix + l));
      const r = { attrs: e };
      return `<pre><code${s.renderAttrs(r)}>${c}</code></pre>\n`;
    }
    return `<pre><code${s.renderAttrs(o)}>${c}</code></pre>\n`;
  }),
  (j.image = function (t, e, n, r, s) {
    const o = t[e];
    return (
  ...
  (j.hardbreak = function (t, e, n) {
    return n.xhtmlOut ? "<br />\n" : "<br>\n";
  }),
  (j.softbreak = function (t, e, n) {
    return n.breaks ? (n.xhtmlOut ? "<br />\n" : "<br>\n") : "\n";
  }),
  (j.text = function (t, e) {
    return v(t[e].content);
  }),
  (j.html_block = function (t, e) {
    return t[e].content;
  }),
  (j.html_inline = function (t, e) {
    return t[e].content;
  }),
  (q.prototype.renderAttrs = function (t) {
    let e, n, r;
    if (!t.attrs) return "";
    for (r = "", e = 0, n = t.attrs.length; e < n; e++)
      r += " " + v(t.attrs[e][0]) + '="' + v(t.attrs[e][1]) + '"';
    return r;
  }),
  (q.prototype.renderToken = function (t, e, n) {
    const r = t[e];
    let s = "";
    if (r.hidden) return "";
    (r.block && -1 !== r.nesting && e && t[e - 1].hidden && (s += "\n"),
      (s += (-1 === r.nesting ? "</" : "<") + r.tag),
  ...
  (q.prototype.renderInline = function (t, e, n) {
    let r = "";
    const s = this.rules;
    for (let o = 0, i = t.length; o < i; o++) {
      const i = t[o].type;
      void 0 !== s[i] ? (r += s[i](t, o, e, n, this)) : (r += this.renderToken(t, o, e));
    }
    return r;
  }),
  (q.prototype.renderInlineAsText = function (t, e, n) {
    let r = "";
  ...
  (q.prototype.render = function (t, e, n) {
    let r = "";
    const s = this.rules;
    for (let o = 0, i = t.length; o < i; o++) {
      const i = t[o].type;
  ...
  (P.prototype.__find__ = function (t) {
  ...
  (P.prototype.before = function (t, e, n, r) {
    const s = this.__find__(t),
      o = r || {};
    if (-1 === s) throw new Error("Parser rule not found: " + t);
    (this.__rules__.splice(s, 0, { name: e, enabled: !0, fn: n, alt: o.alt || [] }),
      (this.__cache__ = null));
  }),
  (P.prototype.after = function (t, e, n, r) {
    const s = this.__find__(t),
      o = r || {};
    if (-1 === s) throw new Error("Parser rule not found: " + t);
    (this.__rules__.splice(s + 1, 0, { name: e, enabled: !0, fn: n, alt: o.alt || [] }),
      (this.__cache__ = null));
  }),
  (P.prototype.push = function (t, e, n) {
    const r = n || {};
    (this.__rules__.push({ name: t, enabled: !0, fn: e, alt: r.alt || [] }),
      (this.__cache__ = null));
  }),
  (P.prototype.enable = function (t, e) {
    Array.isArray(t) || (t = [t]);
    const n = [];
    return (
  ...
  (P.prototype.enableOnly = function (t, e) {
    (Array.isArray(t) || (t = [t]),
  ...
  (P.prototype.disable = function (t, e) {
    Array.isArray(t) || (t = [t]);
    const n = [];
    return (
      t.forEach(function (t) {
  ...
  (P.prototype.getRules = function (t) {
...
function K(t) {
  ...
  for (let n = t.length - 1; n >= 0; n--) {
    const r = t[n];
    ("text" !== r.type || e || (r.content = r.content.replace(U, H)),
...
function tt(t, e) {
  ...
  for (let s = 0; s < t.length; s++) {
    ...
    t: for (; l < a; ) {
      ...
      const f = "'" === h[0];
      let d = 32;
      if (h.index - 1 >= 0) d = c.charCodeAt(h.index - 1);
      else
        for (n = s - 1; n >= 0 && "softbreak" !== t[n].type && "hardbreak" !== t[n].type; n--)
          if (t[n].content) {
            d = t[n].content.charCodeAt(t[n].content.length - 1);
            break;
          }
      let k = 32;
      if (l < a) k = c.charCodeAt(l);
      else
        for (n = s + 1; n < t.length && "softbreak" !== t[n].type && "hardbreak" !== t[n].type; n++)
          if (t[n].content) {
            k = t[n].content.charCodeAt(0);
            break;
          }
      const m = z(d) || L(String.fromCharCode(d)),
        g = z(k) || L(String.fromCharCode(k)),
        b = I(d),
        _ = I(k);
      if (
        (_ ? (u = !1) : g && (b || m || (u = !1)),
        b ? (p = !1) : m && (_ || g || (p = !1)),
        34 === k && '"' === h[0] && d >= 48 && d <= 57 && (p = u = !1),
        u && p && ((u = m), (p = g)),
        u || p)
      ) {
        if (p)
          for (n = r.length - 1; n >= 0; n--) {
            let u = r[n];
            if (r[n].level < i) break;
            if (u.single === f && r[n].level === i) {
              let i, p;
              ((u = r[n]),
                f
                  ? ((i = e.md.options.quotes[2]), (p = e.md.options.quotes[3]))
                  : ((i = e.md.options.quotes[0]), (p = e.md.options.quotes[1])),
                (o.content = Y(o.content, h.index, p)),
                (t[u.token].content = Y(t[u.token].content, u.pos, i)),
                (l += p.length - 1),
                u.token === s && (l += i.length - 1),
                (c = o.content),
                (a = c.length),
                (r.length = n));
              continue t;
        ...
        u
          ? r.push({ token: s, pos: h.index, single: f, level: i })
          : p && f && (o.content = Y(o.content, h.index, "’"));
      } else f && (o.content = Y(o.content, h.index, "’"));
    }
  }
}
const et = [
        ...
        for (let n = 0, r = e.length; n < r; n++) {
          ...
          for (let o = r.length - 1; o >= 0; o--) {
            ...
            if ("link_close" !== i.type) {
              if (
                ("html_inline" === i.type && (B(i.content) && s > 0 && s--, W(i.content) && s++),
                !(s > 0) && "text" === i.type && t.md.linkify.test(i.content))
              ) {
                const s = i.content;
                let c = t.md.linkify.match(s);
                const l = [];
                let a = i.level,
                  h = 0;
                c.length > 0 &&
                ...
                for (let e = 0; e < c.length; e++) {
                  ...
                  let o = c[e].text;
                  o = c[e].schema
                    ? "mailto:" !== c[e].schema || /^mailto:/i.test(o)
                  ...
                  if (i > h) {
                    ...
                    ((e.content = s.slice(h, i)), (e.level = a), l.push(e));
                  }
                  ...
                  ((p.content = o), (p.level = a), l.push(p));
                ...
                if (h < s.length) {
                  const e = new t.Token("text", "", 0);
                  ((e.content = s.slice(h)), (e.level = a), l.push(e));
                }
                e[n].children = r = d(r, o, l);
              }
            } else for (o--; r[o].level !== i.level && "link_open" !== r[o].type; ) o--;
          }
        }
    },
  ],
      ...
      if (t.md.options.typographer)
        for (e = t.tokens.length - 1; e >= 0; e--)
          "inline" === t.tokens[e].type &&
            (J.test(t.tokens[e].content) && K(t.tokens[e].children),
            F.test(t.tokens[e].content) && V(t.tokens[e].children));
    },
  ],
  [
    "smartquotes",
    function (t) {
      if (t.md.options.typographer)
        for (let e = t.tokens.length - 1; e >= 0; e--)
          "inline" === t.tokens[e].type &&
            Q.test(t.tokens[e].content) &&
            tt(t.tokens[e].children, t);
    },
  ],
...
function nt() {
  this.ruler = new P();
  for (let t = 0; t < et.length; t++) this.ruler.push(et[t][0], et[t][1]);
}
function rt(t, e, n, r) {
  ((this.src = t),
    (this.md = e),
    ...
    (this.level = 0));
  const s = this.src;
  for (let o = 0, i = 0, c = 0, l = 0, a = s.length, h = !1; i < a; i++) {
...
((nt.prototype.process = function (t) {
  const e = this.ruler.getRules("");
  for (let n = 0, r = e.length; n < r; n++) e[n](t);
}),
  (nt.prototype.State = Z),
  ...
  (rt.prototype.skipSpaces = function (t) {
    for (let e = this.src.length; t < e; t++) {
      if (!w(this.src.charCodeAt(t))) break;
    }
    return t;
  }),
  (rt.prototype.skipSpacesBack = function (t, e) {
    if (t <= e) return t;
    for (; t > e; ) if (!w(this.src.charCodeAt(--t))) return t + 1;
    return t;
  }),
  ...
  (rt.prototype.skipCharsBack = function (t, e, n) {
    if (t <= n) return t;
    for (; t > n; ) if (e !== this.src.charCodeAt(--t)) return t + 1;
    return t;
  }),
  (rt.prototype.getLines = function (t, e, n, r) {
    if (t >= e) return "";
    const s = new Array(e - t);
    for (let o = 0, i = t; i < e; i++, o++) {
      let t = 0;
      const c = this.bMarks[i];
      let l,
        a = c;
      for (l = i + 1 < e || r ? this.eMarks[i] + 1 : this.eMarks[i]; a < l && t < n; ) {
        const e = this.src.charCodeAt(a);
        if (w(e)) 9 === e ? (t += 4 - ((t + this.bsCount[i]) % 4)) : t++;
        else {
          if (!(a - c < this.tShift[i])) break;
          t++;
        }
        a++;
      }
      s[o] = t > n ? new Array(t - n + 1).join(" ") + this.src.slice(a, l) : this.src.slice(a, l);
    }
    return s.join("");
  }),
  (rt.prototype.Token = R));
function st(t, e) {
...
function ot(t) {
  ...
  for (; r < n; )
    (124 === s &&
      (o
        ? ((c += t.substring(i, r - 1)), (i = r))
        : (e.push(c + t.substring(i, r)), (c = ""), (i = r + 1))),
      (o = 92 === s),
      r++,
      (s = t.charCodeAt(r)));
...
function it(t, e) {
  ...
  if (r < n) {
    if (!w(t.src.charCodeAt(r))) return -1;
  }
  return r;
}
function ct(t, e) {
  ...
  for (;;) {
    if (s >= r) return -1;
    if (((o = t.src.charCodeAt(s++)), !(o >= 48 && o <= 57))) {
      if (41 === o || 46 === o) break;
      return -1;
    }
    if (s - n >= 10) return -1;
  }
  return s < r && ((o = t.src.charCodeAt(s)), !w(o)) ? -1 : s;
}
const lt =
...
const ft = [
  ...
  [
    ...
    function (t, e, n, r) {
      ...
      const i = t.src.charCodeAt(o++);
      if (124 !== i && 45 !== i && 58 !== i) return !1;
      if (o >= t.eMarks[s]) return !1;
      const c = t.src.charCodeAt(o++);
      if (124 !== c && 45 !== c && 58 !== c && !w(c)) return !1;
      if (45 === i && w(c)) return !1;
      for (; o < t.eMarks[s]; ) {
        const e = t.src.charCodeAt(o);
        if (124 !== e && 45 !== e && 58 !== e && !w(e)) return !1;
        o++;
      }
      let l = st(t, e + 1),
        a = l.split("|");
      ...
      if (((l = st(t, e).trim()), -1 === l.indexOf("|"))) return !1;
      ...
      for (let g = 0; g < a.length; g++) {
        ...
        h[g] && (e.attrs = [["style", "text-align:" + h[g]]]);
        const n = t.push("inline", "", 0);
        ((n.content = a[g].trim()), (n.children = []), t.push("th_close", "th", -1));
      }
      let k;
      ...
      for (s = e + 2; s < n && !(t.sCount[s] < t.blkIndent); s++) {
        let r = !1;
        for (let e = 0, o = f.length; e < o; e++)
          if (f[e](t, s, n, !0)) {
            r = !0;
            break;
          }
        if (r) break;
        if (((l = st(t, s).trim()), !l)) break;
        ...
        if (
          ...
          break;
        if (s === e + 2) {
          t.push("tbody_open", "tbody", 1).map = k = [e + 2, 0];
        }
        ...
        for (let e = 0; e < u; e++) {
          ...
          ((r.content = a[e] ? a[e].trim() : ""), (r.children = []), t.push("td_close", "td", -1));
        }
        t.push("tr_close", "tr", -1);
      }
      return (
        k && (t.push("tbody_close", "tbody", -1), (k[1] = s)),
  ...
  [
    ...
    function (t, e, n) {
      ...
      return (
        (o.content = t.getLines(e, s, 4 + t.blkIndent, !1) + "\n"),
        (o.map = [e, t.line]),
        !0
      );
    },
  ...
  [
    ...
    function (t, e, n, r) {
      ...
      if (t.sCount[e] - t.blkIndent >= 4) return !1;
      if (s + 3 > o) return !1;
      const i = t.src.charCodeAt(s);
      if (126 !== i && 96 !== i) return !1;
      let c = s;
      s = t.skipChars(s, i);
      let l = s - c;
      if (l < 3) return !1;
      const a = t.src.slice(c, s),
        h = t.src.slice(s, o);
      ...
      for (
        ;
        (u++, !(u >= n)) &&
        ((s = c = t.bMarks[u] + t.tShift[u]),
        (o = t.eMarks[u]),
        !(s < o && t.sCount[u] < t.blkIndent));
      )
        if (
          t.src.charCodeAt(s) === i &&
          !(
            t.sCount[u] - t.blkIndent >= 4 ||
            ((s = t.skipChars(s, i)), s - c < l || ((s = t.skipSpaces(s)), s < o))
          )
        ) {
          p = !0;
          break;
        }
      ((l = t.sCount[e]), (t.line = u + (p ? 1 : 0)));
      const f = t.push("fence", "code", 0);
      return (
        (f.info = h),
        (f.content = t.getLines(e + 1, u, l, !0)),
        (f.markup = a),
        (f.map = [e, t.line]),
        !0
      );
  ...
  [
    ...
    function (t, e, n, r) {
      ...
      for (f = e; f < n; f++) {
        ...
        if (((s = t.bMarks[f] + t.tShift[f]), (o = t.eMarks[f]), s >= o)) break;
        if (62 === t.src.charCodeAt(s++) && !e) {
          ...
          32 === t.src.charCodeAt(s)
            ...
            : 9 === t.src.charCodeAt(s)
              ? ((e = !0), (t.bsCount[f] + r) % 4 == 3 ? (s++, r++, (n = !1)) : (n = !0))
              : (e = !1);
          let i = r;
          for (c.push(t.bMarks[f]), t.bMarks[f] = s; s < o; ) {
            const e = t.src.charCodeAt(s);
            if (!w(e)) break;
            (9 === e ? (i += 4 - ((i + t.bsCount[f] + (n ? 1 : 0)) % 4)) : i++, s++);
          }
          ((d = s >= o),
            l.push(t.bsCount[f]),
  ...
  [
    ...
    function (t, e, n, r) {
      ...
      return ((l.map = [e, t.line]), (l.markup = Array(c + 1).join(String.fromCharCode(i))), !0);
    },
    ["paragraph", "reference", "blockquote", "list"],
  ],
  [
    ...
    function (t, e, n, r) {
      ...
      if (t.listIndent >= 0 && t.sCount[l] - t.listIndent >= 4 && t.sCount[l] < t.blkIndent)
        return !1;
      let h,
        u,
        p,
        f = !1;
      if (
        (r && "paragraph" === t.parentType && t.sCount[l] >= t.blkIndent && (f = !0),
        (p = ct(t, l)) >= 0)
      ) {
        if (
          ((h = !0),
          (i = t.bMarks[l] + t.tShift[l]),
          (u = Number(t.src.slice(i, p - 1))),
          f && 1 !== u)
        )
          return !1;
      } else {
        if (!((p = it(t, l)) >= 0)) return !1;
        h = !1;
      }
      if (f && t.skipSpaces(p) >= t.eMarks[l]) return !1;
      if (r) return !0;
      const d = t.src.charCodeAt(p - 1),
        k = t.tokens.length;
      h
        ? ((c = t.push("ordered_list_open", "ol", 1)), 1 !== u && (c.attrs = [["start", u]]))
        : (c = t.push("bullet_list_open", "ul", 1));
      const m = [l, 0];
      ((c.map = m), (c.markup = String.fromCharCode(d)));
      let g = !1;
      const b = t.md.block.ruler.getRules("list"),
        _ = t.parentType;
      for (t.parentType = "list"; l < n; ) {
        ((o = p), (s = t.eMarks[l]));
        const e = t.sCount[l] + p - (t.bMarks[l] + t.tShift[l]);
        let r = e;
        for (; o < s; ) {
          const e = t.src.charCodeAt(o);
          if (9 === e) r += 4 - ((r + t.bsCount[l]) % 4);
          else {
            if (32 !== e) break;
            r++;
          }
        ...
        ((f = u >= s ? 1 : r - e), f > 4 && (f = 1));
        const k = e + f;
        ((c = t.push("list_item_open", "li", 1)), (c.markup = String.fromCharCode(d)));
        const m = [l, 0];
        ((c.map = m), h && (c.info = t.src.slice(i, p - 1)));
        const _ = t.tight,
          C = t.tShift[l],
          y = t.sCount[l],
          A = t.listIndent;
        if (
          ...
          (t.blkIndent = k),
          (t.tight = !0),
          (t.tShift[l] = u - t.bMarks[l]),
          (t.sCount[l] = r),
          u >= s && t.isEmpty(l + 1)
            ? (t.line = Math.min(t.line + 2, n))
            : t.md.block.tokenize(t, l, n, !0),
          (t.tight && !g) || (a = !1),
          (g = t.line - l > 1 && t.isEmpty(t.line - 1)),
          (t.blkIndent = t.listIndent),
          (t.listIndent = A),
          (t.tShift[l] = C),
          (t.sCount[l] = y),
          (t.tight = _),
          (c = t.push("list_item_close", "li", -1)),
        ...
        if (x) break;
        if (h) {
          if (((p = ct(t, l)), p < 0)) break;
          i = t.bMarks[l] + t.tShift[l];
        } else if (((p = it(t, l)), p < 0)) break;
        if (d !== t.src.charCodeAt(p - 1)) break;
      }
      return (
        (c = h ? t.push("ordered_list_close", "ol", -1) : t.push("bullet_list_close", "ul", -1)),
        (c.markup = String.fromCharCode(d)),
        (m[1] = l),
        (t.line = l),
        (t.parentType = _),
    ...
    function (t, e, n, r) {
      ...
      function c(e) {
        ...
        if ((t.sCount[e] - t.blkIndent > 3 && (r = !0), t.sCount[e] < 0 && (r = !0), !r)) {
          ...
          if (((t.parentType = s), o)) return null;
        }
        const s = t.bMarks[e] + t.tShift[e],
          o = t.eMarks[e];
        return t.src.slice(s, o + 1);
      }
      let l = t.src.slice(s, o + 1);
      o = l.length;
      let a = -1;
      for (s = 1; s < o; s++) {
        const t = l.charCodeAt(s);
        if (91 === t) return !1;
        if (93 === t) {
          a = s;
          break;
        ...
        if (10 === t) {
          const t = c(i);
          null !== t && ((l += t), (o = l.length), i++);
        } else if (92 === t && (s++, s < o && 10 === l.charCodeAt(s))) {
          const t = c(i);
          null !== t && ((l += t), (o = l.length), i++);
        }
      }
      if (a < 0 || 58 !== l.charCodeAt(a + 1)) return !1;
      for (s = a + 2; s < o; s++) {
        const t = l.charCodeAt(s);
        if (10 === t) {
          const t = c(i);
      ...
      const h = t.md.helpers.parseLinkDestination(l, s, o);
      if (!h.ok) return !1;
      ...
      let k,
        m = t.md.helpers.parseLinkTitle(l, s, o);
      for (; m.can_continue; ) {
        const e = c(i);
        if (null === e) break;
        ((l += e), (s = o), (o = l.length), i++, (m = t.md.helpers.parseLinkTitle(l, s, o, m)));
      }
      for (
        s < o && d !== s && m.ok ? ((k = m.str), (s = m.pos)) : ((k = ""), (s = p), (i = f));
        s < o;
      ) {
        if (!w(l.charCodeAt(s))) break;
        s++;
      }
      if (s < o && 10 !== l.charCodeAt(s) && k)
        for (k = "", s = p, i = f; s < o; ) {
          if (!w(l.charCodeAt(s))) break;
          s++;
        }
      if (s < o && 10 !== l.charCodeAt(s)) return !1;
      const g = T(l.slice(1, a));
      return (
        !!g &&
        (r ||
          (void 0 === t.env.references && (t.env.references = {}),
          void 0 === t.env.references[g] && (t.env.references[g] = { title: k, href: u }),
          (t.line = i)),
        !0)
      );
    },
  ...
  [
    ...
    function (t, e, n, r) {
      ...
      let i = t.src.slice(s, o),
        c = 0;
      for (; c < pt.length && !pt[c][0].test(i); c++);
      if (c === pt.length) return !1;
      if (r) return pt[c][2];
      let l = e + 1;
      if (!pt[c][1].test(i))
  ...
  [
    ...
    function (t, e, n, r) {
      ...
      if (35 !== i || s >= o) return !1;
      let c = 1;
      for (i = t.src.charCodeAt(++s); 35 === i && s < o && c <= 6; )
        (c++, (i = t.src.charCodeAt(++s)));
      if (c > 6 || (s < o && !w(i))) return !1;
      if (r) return !0;
      o = t.skipSpacesBack(o, s);
      const l = t.skipCharsBack(o, 35, s);
      (l > s && w(t.src.charCodeAt(l - 1)) && (o = l), (t.line = e + 1));
      const a = t.push("heading_open", "h" + String(c), 1);
      ((a.markup = "########".slice(0, c)), (a.map = [e, t.line]));
      const h = t.push("inline", "", 0);
      return (
        (h.content = t.src.slice(s, o).trim()),
        (h.map = [e, t.line]),
        (h.children = []),
        (t.push("heading_close", "h" + String(c), -1).markup = "########".slice(0, c)),
        !0
      );
    },
    ["paragraph", "reference", "blockquote"],
  ...
  [
    ...
    function (t, e, n) {
      ...
      let o,
        i = 0,
        c = e + 1;
      for (; c < n && !t.isEmpty(c); c++) {
        if (t.sCount[c] - t.blkIndent > 3) continue;
        if (t.sCount[c] >= t.blkIndent) {
          let e = t.bMarks[c] + t.tShift[c];
          const n = t.eMarks[c];
          if (
            e < n &&
            ((o = t.src.charCodeAt(e)),
            (45 === o || 61 === o) && ((e = t.skipChars(e, o)), (e = t.skipSpaces(e)), e >= n))
          ) {
            i = 61 === o ? 1 : 2;
            break;
          }
        }
        if (t.sCount[c] < 0) continue;
        let e = !1;
      ...
      if (!i) return !1;
      const l = t.getLines(e, c, t.blkIndent, !1).trim();
      t.line = c + 1;
      ...
      return (
        ...
        (h.map = [e, t.line - 1]),
        (h.children = []),
        (t.push("heading_close", "h" + String(i), -1).markup = String.fromCharCode(o)),
        (t.parentType = s),
        !0
      );
    },
  ...
  [
    ...
    function (t, e, n) {
      ...
      const i = t.getLines(e, o, t.blkIndent, !1).trim();
...
function dt() {
  ...
  for (let t = 0; t < ft.length; t++)
    this.ruler.push(ft[t][0], ft[t][1], { alt: (ft[t][2] || []).slice() });
}
function kt(t, e, n, r) {
  ((this.src = t),
    (this.env = n),
...
((dt.prototype.tokenize = function (t, e, n) {
  ...
  for (
    ;
    i < n && ((t.line = i = t.skipEmptyLines(i)), !(i >= n)) && !(t.sCount[i] < t.blkIndent);
  ) {
    if (t.level >= o) {
      t.line = n;
      break;
    ...
    ((t.tight = !c),
      ...
      (i = t.line),
      i < n && t.isEmpty(i) && ((c = !0), i++, (t.line = i)));
  }
}),
  (dt.prototype.parse = function (t, e, n, r) {
    if (!t) return;
    const s = new this.State(t, e, n, r);
    this.tokenize(s, s.line, s.lineMax);
  }),
  (dt.prototype.State = rt),
  (kt.prototype.pushPending = function () {
    const t = new R("text", "", 0);
    return (
  ...
  (kt.prototype.scanDelims = function (t, e) {
    const n = this.posMax,
    ...
    const i = o - t,
      c = o < n ? this.src.charCodeAt(o) : 32,
      l = z(s) || L(String.fromCharCode(s)),
      a = z(c) || L(String.fromCharCode(c)),
      h = I(s),
      u = I(c),
      p = !u && (!a || h || l),
      f = !h && (!l || u || a);
    return { can_open: p && (e || !f || l), can_close: f && (e || !p || a), length: i };
  }),
  (kt.prototype.Token = R));
const gt = /(?:^|[^a-z0-9.+-])([a-z][a-z0-9.+-]*)$/i;
const bt = [];
for (let Zt = 0; Zt < 256; Zt++) bt.push(0);
function _t(t, e) {
  let n;
  const r = [],
    s = e.length;
  ...
  for (; r.length; ) {
    ...
    (s--, e !== s && ((n = t.tokens[s]), (t.tokens[s] = t.tokens[e]), (t.tokens[e] = n)));
  }
}
...
const Ct = {
  tokenize: function (t, e) {
    ...
    if (o < 2) return !1;
    let c;
    o % 2 && ((c = t.push("text", "", 0)), (c.content = i), o--);
    for (let l = 0; l < o; l += 2)
      ((c = t.push("text", "", 0)),
        (c.content = i + i),
        t.delimiters.push({
  ...
  postProcess: function (t) {
    ...
    _t(t, t.delimiters);
    for (let r = 0; r < n; r++) e[r] && e[r].delimiters && _t(t, e[r].delimiters);
  },
};
function yt(t, e) {
...
const At = {
  tokenize: function (t, e) {
    ...
    const s = t.scanDelims(t.pos, 42 === r);
  ...
  postProcess: function (t) {
    const e = t.tokens_meta,
      n = t.tokens_meta.length;
    yt(t, t.delimiters);
    for (let r = 0; r < n; r++) e[r] && e[r].delimiters && yt(t, e[r].delimiters);
  },
};
const xt =
    /^([a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)$/,
  Mt = /^([a-zA-Z][a-zA-Z0-9+.-]{1,31}):([^<>\x00-\x20]*)$/;
const vt = /^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i,
  St = /^&([a-z][a-z0-9]{1,31});/i;
function wt(t) {
  const e = {},
    n = t.length;
  if (!n) return;
  ...
  for (let i = 0; i < n; i++) {
    ...
    if (
      (o.push(0),
      (t[r].marker === n.marker && s === n.token - 1) || (r = i),
      (s = n.token),
      (n.length = n.length || 0),
      !n.close)
    )
    ...
    const c = e[n.marker][(n.open ? 3 : 0) + (n.length % 3)];
    let l = r - o[r] - 1,
      a = l;
    for (; l > c; l -= o[l] + 1) {
      const e = t[l];
      if (e.marker === n.marker && e.open && e.end < 0) {
        ...
        if (
          ((e.close || n.open) &&
            ...
            ((e.length % 3 == 0 && n.length % 3 == 0) || (r = !0)),
          !r)
        ) {
          const r = l > 0 && !t[l - 1].open ? o[l - 1] + 1 : 0;
          ((o[i] = i - l + r),
            (o[l] = r),
            (n.open = !1),
            (e.end = i),
    ...
    -1 !== a && (e[n.marker][(n.open ? 3 : 0) + ((n.length || 0) % 3)] = a);
  }
}
const It = [
    [
      ...
      function (t, e) {
        let n = t.pos;
        for (; n < t.posMax && !mt(t.src.charCodeAt(n)); ) n++;
    ...
    [
      ...
      function (t, e) {
        ...
        const r = t.pending.match(gt);
        if (!r) return !1;
        const s = r[1],
          o = t.md.linkify.matchAtStart(t.src.slice(n - s.length));
        if (!o) return !1;
        let i = o.url;
        if (i.length <= s.length) return !1;
        let c = i.length;
        for (; c > 0 && 42 === i.charCodeAt(c - 1); ) c--;
        c !== i.length && (i = i.slice(0, c));
        const l = t.md.normalizeLink(i);
        ...
        return ((t.pos += i.length - s.length), !0);
      },
    ],
    [
      "newline",
      function (t, e) {
        ...
        for (n++; n < s && w(t.src.charCodeAt(n)); ) n++;
        return ((t.pos = n), !0);
      },
    ],
    [
      ...
      function (t, e) {
        ...
        if (10 === s) {
          for (e || t.push("hardbreak", "br", 0), n++; n < r && ((s = t.src.charCodeAt(n)), w(s)); )
            n++;
          return ((t.pos = n), !0);
        }
        let o = t.src[n];
        ...
        if (!e) {
          ...
          (s < 256 && 0 !== bt[s] ? (e.content = o) : (e.content = i),
            (e.markup = i),
            (e.info = "escape"));
        }
        return ((t.pos = n + 1), !0);
    ...
    [
      ...
      function (t, e) {
        ...
        const o = t.src.slice(r, n),
          i = o.length;
        if (t.backticksScanned && (t.backticks[i] || 0) <= r)
          return (e || (t.pending += o), (t.pos += i), !0);
        let c,
          l = n;
        for (; -1 !== (c = t.src.indexOf("`", l)); ) {
          for (l = c + 1; l < s && 96 === t.src.charCodeAt(l); ) l++;
          const r = l - c;
          if (r === i) {
            if (!e) {
        ...
        return ((t.backticksScanned = !0), e || (t.pending += o), (t.pos += i), !0);
      },
    ],
    ...
    [
      ...
      function (t, e) {
        ...
        if (f < 0) return !1;
        let d = f + 1;
        if (d < u && 40 === t.src.charCodeAt(d)) {
          for (a = !1, d++; d < u && ((n = t.src.charCodeAt(d)), w(n) || 10 === n); d++);
          if (d >= u) return !1;
          if (((l = d), (s = t.md.helpers.parseLinkDestination(t.src, d, t.posMax)), s.ok)) {
            for (
              i = t.md.normalizeLink(s.str), t.md.validateLink(i) ? (d = s.pos) : (i = ""), l = d;
              d < u && ((n = t.src.charCodeAt(d)), w(n) || 10 === n);
              d++
            );
            if (((s = t.md.helpers.parseLinkTitle(t.src, d, t.posMax)), d < u && l !== d && s.ok))
              for (
                c = s.str, d = s.pos;
                d < u && ((n = t.src.charCodeAt(d)), w(n) || 10 === n);
                d++
          ...
          ((d >= u || 41 !== t.src.charCodeAt(d)) && (a = !0), d++);
        }
        if (a) {
          if (void 0 === t.env.references) return !1;
          if (
            (d < u && 91 === t.src.charCodeAt(d)
              ? ((l = d + 1),
                (d = t.md.helpers.parseLinkLabel(t, d)),
                d >= 0 ? (r = t.src.slice(l, d++)) : (d = f + 1))
              : (d = f + 1),
            r || (r = t.src.slice(p, f)),
            (o = t.env.references[T(r)]),
            !o)
          )
            return ((t.pos = h), !1);
          ((i = o.href), (c = o.title));
    ...
    [
      ...
      function (t, e) {
        ...
        if (d < 0) return !1;
        if (((o = d + 1), o < p && 40 === t.src.charCodeAt(o))) {
          for (o++; o < p && ((n = t.src.charCodeAt(o)), w(n) || 10 === n); o++);
          if (o >= p) return !1;
          for (
            a = o,
              c = t.md.helpers.parseLinkDestination(t.src, o, t.posMax),
              c.ok &&
                ((h = t.md.normalizeLink(c.str)), t.md.validateLink(h) ? (o = c.pos) : (h = "")),
              a = o;
            o < p && ((n = t.src.charCodeAt(o)), w(n) || 10 === n);
            o++
          );
          if (((c = t.md.helpers.parseLinkTitle(t.src, o, t.posMax)), o < p && a !== o && c.ok))
            for (l = c.str, o = c.pos; o < p && ((n = t.src.charCodeAt(o)), w(n) || 10 === n); o++);
          else l = "";
          ...
          if (void 0 === t.env.references) return !1;
          if (
            (o < p && 91 === t.src.charCodeAt(o)
              ? ((a = o + 1),
                (o = t.md.helpers.parseLinkLabel(t, o)),
                o >= 0 ? (s = t.src.slice(a, o++)) : (o = d + 1))
              : (o = d + 1),
            s || (s = t.src.slice(f, d)),
            (i = t.env.references[T(s)]),
            !i)
          )
            return ((t.pos = u), !1);
          ((h = i.href), (l = i.title));
        ...
        if (!e) {
          ...
          ((n.attrs = s), (n.children = e), (n.content = r), l && s.push(["title", l]));
        }
    ...
    [
      ...
      function (t, e) {
        ...
        if (
          ...
          return !1;
        const o = t.src.slice(r).match(ht);
        if (!o) return !1;
        if (!e) {
          const e = t.push("html_inline", "", 0);
          ((e.content = o[0]),
            (i = e.content),
            /^<a[>\s]/i.test(i) && t.linkLevel++,
            (function (t) {
              return /^<\/a\s*>/i.test(t);
    ...
    [
      ...
      function (t, e) {
        ...
        if (35 === t.src.charCodeAt(n + 1)) {
          const r = t.src.slice(n).match(vt);
          if (r) {
            if (!e) {
              const e =
                  "x" === r[1][0].toLowerCase() ? parseInt(r[1].slice(1), 16) : parseInt(r[1], 10),
                n = t.push("text_special", "", 0);
              ((n.content = k(e) ? m(e) : m(65533)), (n.markup = r[0]), (n.info = "entity"));
            }
            return ((t.pos += r[0].length), !0);
          }
        } else {
          const r = t.src.slice(n).match(St);
          if (r) {
            const n = l(r[0]);
            if (n !== r[0]) {
              if (!e) {
    ...
    [
      ...
      function (t) {
        const e = t.tokens_meta,
          n = t.tokens_meta.length;
        wt(t.delimiters);
        for (let r = 0; r < n; r++) e[r] && e[r].delimiters && wt(e[r].delimiters);
      },
    ],
      ...
      function (t) {
        ...
        for (e = n = 0; e < o; e++)
          (s[e].nesting < 0 && r--,
            (s[e].level = r),
            s[e].nesting > 0 && r++,
            "text" === s[e].type && e + 1 < o && "text" === s[e + 1].type
...
function zt() {
  this.ruler = new P();
  for (let t = 0; t < It.length; t++) this.ruler.push(It[t][0], It[t][1]);
  this.ruler2 = new P();
  for (let t = 0; t < Lt.length; t++) this.ruler2.push(Lt[t][0], Lt[t][1]);
}
((zt.prototype.skipToken = function (t) {
  const e = t.pos,
  ...
  if (t.level < s) {
    for (let c = 0; c < r; c++)
      if ((t.level++, (i = n[c](t, !0)), t.level--, i)) {
  ...
  (zt.prototype.tokenize = function (t) {
    const e = this.ruler.getRules(""),
      n = e.length,
      r = t.posMax,
      s = t.md.options.maxNesting;
  ...
  (zt.prototype.parse = function (t, e, n, r) {
    const s = new this.State(t, e, n, r);
    this.tokenize(s);
    const o = this.ruler2.getRules(""),
      i = o.length;
    for (let c = 0; c < i; c++) o[c](s);
  }),
  (zt.prototype.State = kt));
const Tt = {
    default: {
      options: {
  ...
  Et = /^(vbscript|javascript|file|data):/,
  Ot = /^data:image\/(gif|png|jpeg|webp);/;
function $t(t) {
  const e = t.trim().toLowerCase();
  return !Et.test(e) || Ot.test(e);
}
const jt = ["http:", "https:", "mailto:"];
function qt(t) {
  const s = e(t, !0);
  if (s.hostname && (!s.protocol || jt.indexOf(s.protocol) >= 0))
    try {
      s.hostname = h.toASCII(s.hostname);
    } catch (o) {}
  return n(r(s));
}
function Pt(t) {
  const n = e(t, !0);
  if (n.hostname && (!n.protocol || jt.indexOf(n.protocol) >= 0))
    try {
      n.hostname = h.toUnicode(n.hostname);
    } catch (o) {}
  return s(r(n), s.defaultChars + "%");
}
function Rt(t, e) {
  ...
  (e || u(t) || ((e = t || {}), (t = "default")),
    ...
    (this.linkify = new a()),
    (this.validateLink = $t),
    (this.normalizeLink = qt),
    (this.normalizeLinkText = Pt),
    (this.utils = O),
    (this.helpers = f({}, $)),
    (this.options = {}),
    this.configure(t),
...
((Rt.prototype.set = function (t) {
  return (f(this.options, t), this);
}),
  (Rt.prototype.configure = function (t) {
    const e = this;
    if (u(t)) {
      const e = t;
      if (!(t = Tt[e])) throw new Error('Wrong `markdown-it` preset "' + e + '", check name');
    }

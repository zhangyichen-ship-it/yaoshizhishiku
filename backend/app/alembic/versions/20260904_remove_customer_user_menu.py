"""Remove the legacy local user-management menu from customer KB."""

import sqlalchemy as sa

from alembic import op

revision = "20260904_remove_customer_user"
down_revision = "20260904_control_plane_config"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    delete_ids = {
        row["id"]
        for row in rows
        if row["route_name"] == "User" or row["component_path"] == "module_system/user/index"
    }
